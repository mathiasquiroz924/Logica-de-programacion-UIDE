...
- Mediante los aprendizajes aprendidos en la clase con la profe, desarrollar un juego interactivo de Piedra, Papel o Tijera que permita aplicar lógica de programación básica y programación funcional, fomentando la interacción con el usuario y el uso de estructuras condicionales y generación aleatoria de datos.
